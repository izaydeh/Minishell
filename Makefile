...
SRCS =src/main.c src/execute/get_path.c src/builtin/ft_cd.c src/builtin/ft_echo.c src/builtin/env/old_pwd.c src/builtin/env/shell_level.c src/builtin/env/new_pwd.c src/builtin/env/ft_env.c src/builtin/ft_export.c src/builtin/ft_unset.c src/builtin/ft_pwd.c src/builtin/is_builtin_function.c src/execute/pipe.c src/signals/handle_signals.c src/execute/redirection.c src/utils.c src/expander/expand_tokens.c
